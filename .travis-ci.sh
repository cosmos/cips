...
HTMLPROOFER_OPTIONS="./_site --internal-domains=cips.cosmos.org --check-html --check-opengraph --report-missing-names --log-level=:debug --assume-extension --empty-alt-ignore --timeframe=6w --url-ignore=/CIPS/cip-1,CIPS/cip-1,/CIPS/cip-107,/CIPS/cip-858"
